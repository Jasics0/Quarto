...
public class Board extends javax.swing.JFrame {
    ...
    public Board() {
        initComponents();
        while (j1.equals("")) {
            j1 = JOptionPane.showInputDialog(f, "Ingresa el nombre del jugador 1:", "Bienvenido!", JOptionPane.QUESTION_MESSAGE);
            if (j1.equals("")) {
                JOptionPane.showMessageDialog(f, "Debe ingresar un nombre", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
        while (j2.equals("") || j2.equals(j1)) {
            j2 = JOptionPane.showInputDialog(f, "Ingresa el nombre del jugador 2:", "Bienvenido!", JOptionPane.QUESTION_MESSAGE);
            if (j2.equals("")) {
                JOptionPane.showMessageDialog(f, "Debe ingresar un nombre", "Error", JOptionPane.ERROR_MESSAGE);
            } else if (j2.equals(j1)) {
                JOptionPane.showMessageDialog(f, "Nombre de usuario ya existente, por favor digite otro nombre.", "Error", JOptionPane.ERROR_MESSAGE);
